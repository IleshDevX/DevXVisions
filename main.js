        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function showModal(index) {
                ...
                modalLikes.textContent = item.dataset.likes;
            ...
            function initializeHeroButtons() {
                ...
                browseCategoriesBtn.addEventListener('click', () => {
                    ...
                    setTimeout(() => {
                        filterButtons.forEach(btn => btn.classList.add('animate-pulse'));
                        setTimeout(() => {
                            filterButtons.forEach(btn => btn.classList.remove('animate-pulse'));
                        }, 2000);
                    }, 500);
                });
            ...
            function createGalleryItem(imageData, index) {
                ...
                downloadBtn.addEventListener('click', (e) => {
                    ...
                    const link = document.createElement('a');
                    link.href = img.src;
                    link.download = `${imageData.title}.jpg`;
                    link.click();
                });
            ...
            console.log('Darken Gallery initialized successfully!');
        });
